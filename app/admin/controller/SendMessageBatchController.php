...
class SendMessageBatchController extends GetUserController
{
    ...
    private $attachment_path = NULL;
    private $attachment_url = NULL;
    private $system_attachment_path = NULL;
    private $system_attachment_url = NULL;
    protected $type = NULL;
    ...
    public function searchList()
    {
        ...
        if ($params["send_type"] == "clients") {
            ...
            if ($params["send_type"] == "clients_and_host") {
            ...
            switch ($value) {
                ...
                case "CLIENT_STATUS":
                    if ($client_info["status"] == 1) {
                        ...
                        if ($client_info["status"] == 0) {
                            $client_status = "未激活";
                        } else {
                            if ($client_info["status"] == 2) {
                                $client_status = "关闭";
                            } else {
                                $client_status = "未知";
                            }
