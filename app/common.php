    ...
    if (!empty($cookieLanguage) && !empty($lang[$cookieLanguage])) {
        ...
        if (empty($lang[$configLanguage])) {
            if ($configLanguage == "en-us") {
                ...
                if ($configLanguage == "zh-cn") {
                    $language = "chinese";
                } else {
                    if ($configLanguage == "zh-xg") {
                        $language = "chinese_tw";
                    } else {
                        $language = "chinese";
                    }
...
function getSupportedCycles($pid, $currency, $mon_pack_year = 1)
{
    ...
    if ($pay_type_data["pay_type"] == "free" && $mon_pack_year) {
        ...
        if ($pay_type_data["pay_type"] == "onetime" && $mon_pack_year) {
        ...
        if ($aff_id_uid != 0) {
            if ($aff_id) {
                ...
                if (empty($au)) {
                    ...
                    if (!empty($au["affid"]) && $au["affid"] != $aff_id) {
        ...
        if ($record["type"] == "flow_packet") {
            ...
            if ($host["api_type"] == "zjmf_api") {
                ...
                if ($host["product_type"] == "dcim") {
                    ...
                    if ($host["product_type"] == "dcimcloud") {
...
function rangeTypeCheck($phone)
{
    ...
    if ($rangeType == 0) {
        ...
        if ($rangeType == 1 && configuration("shd_allow_sms_send_global") == 0) {
...
function getOS()
{
    ...
    if (preg_match("/win/i", $Agent) && strpos($Agent, "95")) {
        ...
        if (preg_match("/win 9x/i", $Agent) && strpos($Agent, "4.90")) {
            ...
            if (preg_match("/win/i", $Agent) && preg_match("/98/", $Agent)) {
                $os = "Windows 98";
            } else {
                        ...
                        if (preg_match("/win/i", $Agent) && preg_match("/nt 6.1/i", $Agent)) {
                            ...
                            if (preg_match("/win/i", $Agent) && preg_match("/nt 5.1/i", $Agent)) {
                                ...
                                if (preg_match("/win/i", $Agent) && preg_match("/nt/i", $Agent)) {
                                    ...
                                    if (preg_match("/win/i", $Agent) && preg_match("/32/", $Agent)) {
                                        $os = "Windows 32";
                                    } else {
